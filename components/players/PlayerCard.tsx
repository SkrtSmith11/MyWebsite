...
export default function PlayerCard({
  ...
  const stale = isStale(player.lastUpdated);
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-start justify-between gap-2 mb-3">
          ...
          <div className="flex items-center gap-1 shrink-0">
            <button
              ...
              title={tracked.isPinned ? "Unpin" : "Pin player"}
        ...
        {expanded && (
          <div className="grid grid-cols-3 gap-x-2 gap-y-2 pt-3">
            {player.stats.secondary.map((stat) => (
              <StatBadge key={stat.label} stat={stat} size="sm" />
            ))}
          </div>
        )}
